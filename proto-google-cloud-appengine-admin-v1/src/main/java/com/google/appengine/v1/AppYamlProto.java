  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "ion.proto\032\034google/api/annotations.proto\"\340\001\n"
          + "\020ApiConfigHandler\022=\n"
          + "\020auth_fail_action\030\001 \001(\0162#.google.appengine.v1.AuthFailAction\0224\n"
          + "\005login\030\002 \001(\0162%.google.appengine.v1.LoginRequirement\022\016\n"
          + "\006script\030\003 \001(\t\022:\n"
          + "\016security_level\030\004 \001(\0162\".google.appengine.v1.SecurityLevel\022\013\n"
          + "\003url\030\005 \001(\t\"\217\002\n"
          + "\014ErrorHandler\022?\n\n"
          + "error_code\030\001 \001(\0162+.google.appengine.v1.ErrorHandler.ErrorCode\022\023\n"
          ...
          + "\014static_files\030\002"
          + " \001(\0132\'.google.appengine.v1.StaticFilesHandlerH\000\0224\n"
          + "\006script\030\003 \001(\0132\".google.appengine.v1.ScriptHandlerH\000\022?\n"
          + "\014api_endpoint\030\004"
          + " \001(\0132\'.google.appengine.v1.ApiEndpointHandlerH\000\022:\n"
          + "\016security_level\030\005 \001(\0162\".google.appengine.v1.SecurityLevel\0224\n"
          + "\005login\030\006 \001(\0162%.google.appengine.v1.LoginRequirement\022=\n"
          + "\020auth_fail_action\030\007 \001(\0162#.google.appengine.v1.AuthFailAction\022Y\n"
          + "\033redirect_http_response_code\030\010"
          + " \001(\01624.google.appengine.v1.UrlMap.RedirectHttpResponseCode\"\333\001\n"
          + "\030RedirectHttpResponseCode\022+\n"
          + "\'REDIRECT_HTTP_RESPONSE_CODE_UNSPECIFIED\020\000\022#\n"
          + "\037REDIRECT_HTTP_RESPONSE_CODE_301\020\001\022#\n"
          + "\037REDIRECT_HTTP_RESPONSE_CODE_302\020\002\022#\n"
          + "\037REDIRECT_HTTP_RESPONSE_CODE_303\020\003\022#\n"
          + "\037REDIRECT_HTTP_RESPONSE_CODE_307\020\004B\016\n"
          ...
          + "ngine.v1.StaticFilesHandler.HttpHeadersEntry\022\021\n"
          ...
          + "\021healthy_threshold\030\003 \001(\r"
          + "\022\033\n"
          + "\023unhealthy_threshold\030\004 \001(\r"
          + "\022\031\n"
          + "\021restart_threshold\030\005 \001(\r"
          + "\0221\n"
          ...
          + "\004host\030\002 \001(\t\022\031\n"
          + "\021failure_threshold\030\003 \001(\r"
          + "\022\031\n"
          + "\021success_threshold\030\004 \001(\r"
          + "\0221\n"
          ...
          + "\0221\n"
          + "\016check_interval\030\005 \001(\0132\031.google.protobuf.Duration\022*\n"
          + "\007timeout\030\006 \001(\0132\031.google.protobuf.Duration\0220\n\r"
          + "initial_delay\030\007 \001(\0132\031.google.protobuf.Duration\"(\n"
          + "\007Library\022\014\n"
          ...
          + "\r"
          + "SECURE_ALWAYS\020\003\032\002\020\001B\276\001\n"
          + "\027com.google.appengine.v1B\014AppYamlProtoP\001Z<google.golang."
          + "org/genproto/googleapis/appengine/v1;app"
          + "engine\252\002\031Google.Cloud.AppEngine.V1\312\002\031Goo"
          + "gle\\Cloud\\AppEngine\\V1\352\002\034Google::Cloud::AppEngine::V1b\006proto3"
    };
    descriptor =

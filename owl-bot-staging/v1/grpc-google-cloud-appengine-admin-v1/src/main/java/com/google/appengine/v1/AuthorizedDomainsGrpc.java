...
public final class AuthorizedDomainsGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.appengine.v1.ListAuthorizedDomainsRequest,
      com.google.appengine.v1.ListAuthorizedDomainsResponse> getListAuthorizedDomainsMethod;
  ...
  public static io.grpc.MethodDescriptor<com.google.appengine.v1.ListAuthorizedDomainsRequest,
      com.google.appengine.v1.ListAuthorizedDomainsResponse> getListAuthorizedDomainsMethod() {
    io.grpc.MethodDescriptor<com.google.appengine.v1.ListAuthorizedDomainsRequest, com.google.appengine.v1.ListAuthorizedDomainsResponse> getListAuthorizedDomainsMethod;
      ...
      synchronized (AuthorizedDomainsGrpc.class) {
        if ((getListAuthorizedDomainsMethod = AuthorizedDomainsGrpc.getListAuthorizedDomainsMethod) == null) {
          AuthorizedDomainsGrpc.getListAuthorizedDomainsMethod = getListAuthorizedDomainsMethod =
              io.grpc.MethodDescriptor.<com.google.appengine.v1.ListAuthorizedDomainsRequest, com.google.appengine.v1.ListAuthorizedDomainsResponse>newBuilder()
   ...
   * </pre>
   */
  public static abstract class AuthorizedDomainsImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void listAuthorizedDomains(com.google.appengine.v1.ListAuthorizedDomainsRequest request,
        io.grpc.stub.StreamObserver<com.google.appengine.v1.ListAuthorizedDomainsResponse> responseObserver) {
   ...
   * </pre>
   */
  public static final class AuthorizedDomainsStub extends io.grpc.stub.AbstractAsyncStub<AuthorizedDomainsStub> {
    private AuthorizedDomainsStub(
   ...
   * </pre>
   */
  public static final class AuthorizedDomainsBlockingStub extends io.grpc.stub.AbstractBlockingStub<AuthorizedDomainsBlockingStub> {
     ...
     * </pre>
     */
    public com.google.appengine.v1.ListAuthorizedDomainsResponse listAuthorizedDomains(com.google.appengine.v1.ListAuthorizedDomainsRequest request) {
   ...
   * </pre>
   */
  public static final class AuthorizedDomainsFutureStub extends io.grpc.stub.AbstractFutureStub<AuthorizedDomainsFutureStub> {
    private AuthorizedDomainsFutureStub(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.appengine.v1.ListAuthorizedDomainsResponse> listAuthorizedDomains(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_LIST_AUTHORIZED_DOMAINS:
          serviceImpl.listAuthorizedDomains((com.google.appengine.v1.ListAuthorizedDomainsRequest) request,
              (io.grpc.stub.StreamObserver<com.google.appengine.v1.ListAuthorizedDomainsResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class AuthorizedDomainsBaseDescriptorSupplier

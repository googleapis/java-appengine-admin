...
private static final long serialVersionUID = 0L;
  ...
  public int getSerializedSize() {
    ...
    if (searchApiAvailable_ != false) {
      size += com.google.protobuf.CodedOutputStream
        .computeBoolSize(6, searchApiAvailable_);
    }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (getStandardEnvironmentAvailable()
        != other.getStandardEnvironmentAvailable()) return false;
    if (getFlexibleEnvironmentAvailable()
        != other.getFlexibleEnvironmentAvailable()) return false;
    if (getSearchApiAvailable()
        != other.getSearchApiAvailable()) return false;

...
private static final long serialVersionUID = 0L;
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (getTargetWriteBytesPerSecond()
        != other.getTargetWriteBytesPerSecond()) return false;
    if (getTargetWriteOpsPerSecond()
        != other.getTargetWriteOpsPerSecond()) return false;
    if (getTargetReadBytesPerSecond()
